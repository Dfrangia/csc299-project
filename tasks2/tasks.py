...
def execute_command(command, args_list):
    ...
    if command == "add":
        ...
        print("Commands:")
        print("  add <description> [--priority high|medium|low] [--tags tag1,tag2] [--deadline YYYY-MM-DD]")
        print("  list [--completed] [--incomplete] [--priority high|medium|low] [--tag tag]")
        ...
        print("  add-note \"<title>\" \"<content>\" [--tags tag1,tag2] - Add a new note")
        print("  list-notes [--tag tag] - List all notes")
        print("  show-note <id>    - Show full content of a note")
        print("  search-notes <query> - Search notes by title or content")
        print("  link <task_id> <note_id> - Link a task to a note")
